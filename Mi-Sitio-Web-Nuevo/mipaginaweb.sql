...
-- Tiempo de generación: 23-06-2023 a las 04:24:57
...
(1, 'Reemplazos del huevo', 'Opciones:', '1- Linaza o chía: Mezclar una cucharada de semillas de linaza o chía molidas con 3 cucharadas de agua y dejar reposar durante unos 10-15 minutos hasta que se forme un gel. Esta mezcla se puede utilizar para reemplazar un huevo en recetas de horneado.\r\n\r\n2-Puré de banana o de manzana: Utilizar 1/4 de taza de puré de banana madura (aproximadamente la cantidad de un huevo) como sustituto en recetas de panqueques, muffins, pasteles y panes.', 'yrhw0qnkairzs1smkjpg'),
(3, 'Reemplazos de carne', 'Opciones:', 'Podés reemplazar una porción de carne animal por legumbres como garbanzos, lentejas, porotos o una combinación de las mismas.\r\nTambién, podés optar por tofu.\r\n>Tip: Te recomiendo remojar las legumbres\r\nal menos por 12 horas y luego cocinarlas el mismo día. Después de enfriadas, congelalas por separado. Cuando quieras usarlas, con sólo tirar un poco de agua caliente sobre la porción que vas a consumir, ya estarían listas para saborearlas y combinarlas en tu plato con los demás alimentos.', 'jzwjcmtqajgjwlmb4qep'),
(4, 'Reemplazos de queso', 'Opciones:', '1- El queso puede prepararse a base de anacardos; legumbres; papa, entre otros alimentos.\r\n2-También existe la levadura nutricional, que es similar al queso rallado.\r\n\r\n>Tip: en internet podés encontrar muchísimas recetas de quesos veganos con distintos alimentos y son muy fáciles de prepararlos. Te animo a que te desafíes a hacerlos y así probar opciones más nutritivas para tu salud.', 'azcql8sp1xbi06s2oygg');
